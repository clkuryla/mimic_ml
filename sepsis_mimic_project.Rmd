...
# Ensure thirtyday_expire_flag is binary and numeric
# data$thirtyday_expire_flag <- as.numeric(as.character(data$thirtyday_expire_flag)) - 1
...
plot_decision_curve(
  ...
  curve.names = c("Logistic Regression", "SAPS-II", "XGBoost", "LDA"),
  xlab = "Threshold Probability",
  ylab = "Net Benefit",
  col = c("red", "blue", "green", "purple"),  # Custom colors
