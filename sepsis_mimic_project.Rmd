...
train_x <- train_data %>% select(-thirtyday_expire_flag)
train_y <- train_data %>% select(thirtyday_expire_flag)
#train_y <- train_data$thirtyday_expire_flag


test_x <- test_data %>% select(-thirtyday_expire_flag)
test_y <- test_data %>% select(thirtyday_expire_flag)
